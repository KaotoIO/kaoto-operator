...
func (b *KaotoStatusApplyConfiguration) WithPhase(value string) *KaotoStatusApplyConfiguration {
	b.Phase = &value
	return b
}
...
func (b *KaotoStatusApplyConfiguration) WithObservedGeneration(value int64) *KaotoStatusApplyConfiguration {
...
func (b *KaotoStatusApplyConfiguration) WithEndpoint(value string) *KaotoStatusApplyConfiguration {
	b.Endpoint = &value
	return b
}
