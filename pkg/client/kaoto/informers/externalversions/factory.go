...
import (
	...
	designer "github.com/kaotoIO/kaoto-operator/pkg/client/kaoto/informers/externalversions/designer"
...
func (f *sharedInformerFactory) Designer() designer.Interface {
	return designer.New(f, f.namespace, f.tweakListOptions)
}
